...
#	include "Runtime/Threads/ExtendedAtomicOps-x86-64.h"
#	define UNITY_ATOMIC_INT_OVERLOAD

#elif defined (__x86__) || defined (__i386__) || defined (_M_IX86)

#	include "Runtime/Threads/ExtendedAtomicOps-x86.h"

#elif defined (__arm64__) && (defined(__clang__) || defined(__GNUC__))

#	include "Runtime/Threads/ExtendedAtomicOps-arm64.h"
#	define UNITY_ATOMIC_INT_OVERLOAD
...
#	include "Runtime/Threads/ExtendedAtomicOps-arm.h"
...
#elif (UNITY_WEBGL && SUPPORT_THREADS)

#	include "Runtime/Threads/ExtendedAtomicOps-webgl.h"

#elif (defined (__ppc64__) || defined (_ARCH_PPC64)) && (defined (__clang__) || defined (__GNUC__))

#	include "Runtime/Threads/ExtendedAtomicOps-ppc64.h"
#	define UNITY_ATOMIC_INT_OVERLOAD
...
#	define UNITY_NO_ATOMIC_OPS
	...
	{
		return AtomicAdd(const_cast<volatile atomic_word*>(p), 0);
	}
	...
	{
		return AtomicCompareExchange(p, newval, *oldval);
	}
